...
public class Latency4JTestResourcesHandle {
	public static final String CUSTOM_CONFIG_RESOURCE_NAME = "CLASSPATH:/customconfig/latency4j-config.xml";

	public static final String TEST_AOP_MONITOR_CONFIG = "CLASSPATH:/org/latency4j/spring/aop/latency4j-config.xml";
