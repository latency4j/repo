 ...
 * {@link MonitoredByLatency4J Latency4J annotated} classes. Calls to the
 * {@link MonitoredByLatency4J annotated} methods are intercepted and monitored
 * by an {@link Latency4JDynamicProxy Latency4J dynamic proxy}.
 * </p>
 */
public class Latency4JBeanPostProcessor implements BeanPostProcessor {
	...
	/**
	 * <p>
	 * If the given bean contains {@link MonitoredByLatency4J Latency4J annotated
	 * methods}, this method will create and return a
	 * {@link Latency4JDynamicProxy dynamic Latency4J proxy} to it.
	 * </p>
	 * <p>
	 ...
	 *            The name of the bean to process.
	 * 
	 * @return An {@link Latency4JDynamicProxy Latency4J proxy} to the specified
	 ...
	 *         {@link MonitoredByLatency4J Latency4J annotation}; and
