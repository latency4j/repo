...
/**
 * <p>
 * Reads the {@link Latency4JConfiguration Latency4J configuration} from an XML
 * source, and initialises an {@link Latency4JResourceManager Latency4J resource
...
public class ConfigurationReader {
	...
	/**
	 * <p>
	 * Loads an {@link Latency4JConfiguration Latency4J configuration} from the
	 ...
	 *            {@link Latency4JConfiguration Latency4J configuration} XML will be
	 *            read.
	 */
	...
	public static void readConfiguration(final Latency4JResourceManager resourceManager,
		...
		try {
			...
			if (resourceStream == null) {
				String error = "Could not read Latency4J configuration from location '" + configurationResourceURI
						+ "'. Null resource stream.";
				throw new Latency4JException(error);
			} else {
				logger.info("Reading Latency4J configuration file from: " + configurationResourceURI);
