...
import static org.latency4j.util.Latency4JNetAPIConstants.MIME_CONTENT_TYPE_TEXT;
import static org.latency4j.util.Latency4JNetAPIConstants.MIME_CONTENT_TYPE_TEXT_HTML;
import static org.latency4j.util.Latency4JNetAPIConstants.MIME_MIXED_CONTENT_HEADER;
import static org.latency4j.util.Latency4JNetAPIConstants.MIME_MULTIPART_ALTERNATIVE_HEADER;
...
public class Latency4JEmailSender {
	 ...
	 * format. This is in contrast to {@link #Latency4JEmailSender(Session)}, which
	 ...
	 *            constructor {@link #Latency4JEmailSender(Session)} instead, and a
	 *            value of <coe>False</code> will result in all messages being
	 *            sent as plain text.
	 * 
	 * @see #Latency4JEmailSender(Session)
	 */
